    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '2rem' }}>
          <img src="/logo.png?v=2" width="36" height="36" alt="FlowDesk" style={{ display: 'block', flexShrink: 0 }} />
          <div>
            <span style={{ fontSize: '1.1rem', fontWeight: 800, display: 'block', lineHeight: 1 }}>
              Flow<span style={{ color: 'var(--primary)' }}>Desk</span>
            </span>
            <span style={{ fontSize: '0.6rem', color: 'var(--text-muted)', letterSpacing: '0.06em', textTransform: 'uppercase', display: 'block' }}>
